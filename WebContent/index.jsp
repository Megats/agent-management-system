  ...
  <tr>
	...
	<th colspan="2" style="text-align:center">Action</th>
		...
		<tr>
			...
			<td><a href="updateProduct.jsp?productid=<%=resultSet.getString("productid")%>"><button type="button" class="update">Update</button></a></td>
				
			<td><button><a href="delete.jsp?productid=<%=resultSet.getString("productid") %>"onclick="return confirm('Are you sure?')">Delete</button></td></a>
